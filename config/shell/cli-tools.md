...
| `repomix`             | repomix         | Pack repo into single file for LLMs      |
| `onefetch`            | onefetch        | Git repo stats summary                   |
